...
---
_** Updated 28th July 2025_

## A scalable taxi dispatch system

Last semester, I took a class in distributed systems. My solution to one of the assignements was to design and implement 
...
For this piece of coursework, I essentially developed my own version of this system using <a href="https://grpc.io/"> gRPC </a> and a <a href="https://en.wikipedia.org/wiki/Chord_(peer-to-peer)"> the chord protocol (a distributed hash table).</a> Alongside each piece of coursework we must submit a report detailing how to build and run the program, along with our design decisions and possible improvements. Below is my submission for this assigment, and I have open sourced the project as well.
