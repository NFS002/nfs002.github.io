...
For this piece of coursework, I essentially developed my own version of this system using <a href="https://grpc.io/"> gRPC </a> and a <a href="https://en.wikipedia.org/wiki/Chord_(peer-to-peer)"> distributed hash table with constant look ups. </a>. Alongside each piece of coursework we must submit a report detailing how to build and run the program, along with our design decisions and possible improvements. Below is my report, and I have open sourced the project also:
