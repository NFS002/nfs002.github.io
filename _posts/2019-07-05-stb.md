...
Ive been working on this project on and off for a few years now, and I still work on this project whenever I get time. I would like to say that I finished an initial implementation for comprehesive live order management (on the binance exchange only), which includes mechanisms to open, update and monitor, as well as close, live orders. Ive also implemented a bunch of backtesting features for EOD datasets from <a href='https://www.quandl.com/data/EOD-End-of-Day-US-Stock-Prices'>Quandl. </a> Unfortunately however, I have not found a reliable strategy yet.

## Edit 28 Jul 2025
I never consistently used this tool to generate passive income, as it was designed.  I also believe that recently Binance have restricted at least the API to UK accounts, which may or may not be possible to workaround._