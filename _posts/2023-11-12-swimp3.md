...
__** Updated 22 August 2025: It still works, so I do use it fairly regularly.__
...
Swimp3 is a CLI program written in python that can either create a new randomly generated spotify playlist (given a larger 'seed' playlist to make a subselection from), and then download that playlist, or just directly download the given playlist to a collection of mp3 files.
