...
date-string: 27th March 2024
---

__** Updated 22 August 2025: I cant believe I only wrote this post last year, it feels so long ago. Anyway, this one was really cool, and I did try and get it up and running recently, but I couldnt find the right configuration for the different versions of JVM, Kotlin, and the various gradle build plugins I was using. Hopefully ill find the motivation to pick it up again although unfortunately I think it would probably require some paid products or services where I was using a free trial before. If i do bring this back to life, ill probably take the opportunity to rewrite and simplify a bunch as well__
