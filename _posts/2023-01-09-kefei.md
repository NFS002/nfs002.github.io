...
__** Updated 22 August 2025: I broke up with Kefei a few years ago and yeah I do recognise how weird this whole thing is. Im tempted to take it down but i guess its kinda funny or interesting, or something...not sure. Either way, its a cool idea and I put a lot of work into it, so in that sense it deserves a spot on the team__
...
class MyClass: Persistable() {
    ...
    lateinit var notImportantStr: String /* The value of this field is not persisted, its just a regular class property */
...
but if you were to pass an object idenitifier as described above, the path would now become:
