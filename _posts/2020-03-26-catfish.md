...
_** Updated 28th July 2025: After I uploaded this to the Chrome store, Tinder very quickly found it and asked me to take it down, and I didnt wanna risk a legal bottle, so I just did. Fortunately, Ive made the repository public, so you can dowload it from<a href="https://github.com/NFS002/TinderCatfish">Github page</a>and run it in chrome developer mode. Its a shame because I think this was one of my funnest projects with the biggest commercial appeal.
